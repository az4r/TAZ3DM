(defun taz_s_section_cbeam_draw ()
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l1 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l2 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l3 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l4 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l5 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l6 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l7 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
  ...
  ;;(command "_LENGTHEN" "DE" "-1" taz_s_l8 "")
  ;;(command "_ZOOM" "_OBJECT" (entlast) "")
  (command "REGEN")
