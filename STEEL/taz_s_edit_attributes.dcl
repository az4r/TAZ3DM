taz_s_edit_attributes : dialog {
  ...
  : column {
    ...
    : row { : text { label = "RODZINA PROFILU:"; width = 30; fixed_width = true; }  : edit_box { key = "attr6";  edit_width = 20; } }
    : row { : text { label = "TYP PROFILU:"; width = 30; fixed_width = true; }  : edit_box { key = "attr7";  edit_width = 20; } }
    : row { : text { label = "MATERIAL:"; width = 30; fixed_width = true; }  : edit_box { key = "attr8";  edit_width = 20; } }
    : row { : text { label = "FUNKCJA:"; width = 30; fixed_width = true; }  : edit_box { key = "attr9";  edit_width = 20; } }
    : row { : text { label = "ATRYBUT DODATKOWY:"; width = 30; fixed_width = true; } : edit_box { key = "attr10"; edit_width = 20; } }
  }
